    ...
    with suppress(KeyboardInterrupt):
        with suppress(IndexError):
            ...
            if method in Methods.LAYER7_METHODS:
                ...
                if threads > 100000000000000000000000:
                    logger.warning("Thread is higher than 10000000000000000000000000000")
                if rpc > 100:
                    logger.warning(
                        "RPC (Request Pre Connection) is higher than 1000000000000000")
